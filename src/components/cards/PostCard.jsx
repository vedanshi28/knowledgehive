...
function PostCard({ id, post }) {
  ...
  const handleReply = async () => {          //adding comment
        ...
        <div className="flex w-full flex-1 flex-row gap-4">
          ...
          <div className="flex w-full flex-col">
            ...
            <div className="mt-5 flex flex-col gap-3">
              ...
              <p className="mt-1 text-subtle-medium text-gray-1 no-underline">
      ...
      */}
      ...
      >
        <Box sx={style} component="form">
          ...
          <Button sx={{ color: "#6875F5", mt: 2 }} onClick={handleReply} isLoading={isReplying}> 
            Reply
          </Button>
        </Box>
      </Modal>
